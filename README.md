...
<h3 align="center">Implementation of soft computing techniques for NDVI prediction using satellite imagery and environmental data. Utilizes CatBoost, GBM, LightGBM, and XGBoost models to enhance vegetation health monitoring. Includes preprocessing, model training, evaluation, and prediction outputs</h3>
